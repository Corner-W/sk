...
type (
	// RedirectPolicy to regulate the redirects in the httpclient client.
...
//
//	httpclient.SetRedirectPolicy(NoRedirectPolicy())
...
//
//	httpclient.SetRedirectPolicy(FlexibleRedirectPolicy(20))
...
// DomainCheckRedirectPolicy is convenient method to define domain name redirect rule in httpclient client.
// Redirect is allowed for only mentioned host in the policy.
//
//	httpclient.SetRedirectPolicy(DomainCheckRedirectPolicy("host1.com", "host2.org", "host3.net"))
