...
// httpclient client. Request provides an options to override client level
...
//
// To set the header for username "go-httpclient" and password "welcome"
//
//	client.R().SetBasicAuth("go-httpclient", "welcome")
//
...
//	}
//
//	// Setting a cookies into httpclient's current request
...
// for current `Request`.
//
//	resp, err := client.R().Execute(httpclient.GET, "http://httpbin.org/get")
