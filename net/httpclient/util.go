...
// RequestLog struct is used to collected information from httpclient request
// instance for debug logging. It sent to request log callback before httpclient
...
// ResponseLog struct is used to collected information from httpclient response
// instance for debug logging. It sent to response log callback before httpclient
// actually logs the information.
